...
public class AbstractMantisClientRepositoryTest extends AbstractMantisClientTest {
	...
	public void testValidateHTTP() throws Exception {
		...
		IMantisClient mantisClient = MantisClientFactory.createClient(MantisTestConstants.TEST_MANTIS_HTTP_URL, IMantisClient.Version.MC_1_0a5, username, password, null, null, null);
