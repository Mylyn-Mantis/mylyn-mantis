...
public class MantisConnectLocator extends org.apache.axis.client.Service implements com.itsolut.mantis.binding.MantisConnect {
    ...
    public com.itsolut.mantis.binding.MantisConnectPortType getMantisConnectPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.itsolut.mantis.binding.MantisConnectBindingStub _stub = new com.itsolut.mantis.binding.MantisConnectBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.itsolut.mantis.binding.MantisConnectPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.itsolut.mantis.binding.MantisConnectBindingStub _stub = new com.itsolut.mantis.binding.MantisConnectBindingStub(new java.net.URL(MantisConnectPort_address), this);
                _stub.setPortName(getMantisConnectPortWSDDServiceName());
                return _stub;
            }
        }
