...
public class MantisAxis1SOAPClient extends AbstractMantisClient {
    ...
    private static final String MANTIS_1_2_X_PREFIX = "1.2";

    private static final List<String> ACCEPTED_VERSIONS = Arrays.asList("0.0.5", "1.1.*", "1.2.*");

    //how to use proxy?
	public MantisAxis1SOAPClient(URL url, Version version, String username, String password, String httpUsername, String httpPassword, AbstractWebLocation webLocation) {
		super(url, version, username, password, webLocation);
    ...
    public void validate() throws MantisException {
        ...
        try {
            ...
            if (!MANTIS_1_0_X_VERSION.equals(remoteVersion) && !remoteVersion.startsWith(MANTIS_1_1_X_PREFIX) && !remoteVersion.startsWith(MANTIS_1_2_X_PREFIX))
                throw new MantisException("Incompatible version found, got " + remoteVersion + " , expecting one of  " + ACCEPTED_VERSIONS);
