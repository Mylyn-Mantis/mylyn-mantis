...
public abstract class AbstractMantisClient implements IMantisClient {
	...
	public AbstractMantisClient(URL repositoryUrl, Version version, String username, String password, Proxy proxy) {
...
//	public MantisTicketType[] getTicketTypes() {
//		return (data.ticketTypes != null) ? data.ticketTypes.toArray(new MantisTicketType[0]) : null;
//	}
//
//	public MantisVersion[] getVersions() {
//		return (data.versions != null) ? data.versions.toArray(new MantisVersion[0]) : null;
//	}
