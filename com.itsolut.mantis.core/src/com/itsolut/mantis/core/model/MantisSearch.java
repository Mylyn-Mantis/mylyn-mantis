/*******************************************************************************
 * Copyright (c) 2006 - 2006 Mylar eclipse.org project and others. All rights reserved. This program and the
 * accompanying materials are made available under the terms of the Eclipse Public License v1.0 which accompanies this
 * distribution, and is available at http://www.eclipse.org/legal/epl-v10.html
 * 
 * Contributors: Mylar project committers - initial API and implementation
 *******************************************************************************/
...
/**
 * Represents a Mantis search. A search can have multiple {@link MantisSearchFilter}s that all need to match.
 * 
...
public class MantisSearch {
    ...
    /**
     * Returns a Mantis query string that conforms to the format defined at {@link http
     * ://projects.edgewall.com/trac/wiki/MantisQuery#QueryLanguage}.
     * 
    ...
    /**
     * Returns a URL encoded string that can be passed as an argument to the Mantis query script.
     * 
     * @return the empty string, if no search order and criteria are defined; a string that starts with &amp;, otherwise
     */
    public String toUrl() {
