 ...
 *     David Carver - Migrated to Mylyn 3.0
 *******************************************************************************/
 ...
 * @since 2.0
 */
public class MantisRepositoryQuery extends RepositoryQuery {
	
	public MantisRepositoryQuery(String repositoryUrl, String queryUrl, String description) {
		super(description);
