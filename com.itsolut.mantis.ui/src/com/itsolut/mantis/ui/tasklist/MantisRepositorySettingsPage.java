...
public class MantisRepositorySettingsPage extends AbstractRepositorySettingsPage {
	...
	protected Validator getValidator(TaskRepository repository) {
		// TODO Auto-generated method stub
		return new MantisValidator(repository, Version.MC_1_0a5, getUserName(), getPassword(), getHttpAuthUserId(), getHttpAuthPassword());
	}
	...
	public class MantisValidator extends Validator {
		...
		public MantisValidator(TaskRepository taskRepository, Version version, String userName, String password, String httpUserName, String httpPassword) {
		...
		public void validate(IProgressMonitor monitor) throws MalformedURLException, MantisException {
			...
			IMantisClient client = MantisClientFactory.createClient(location.getUrl(), version, this.userName, this.password, this.httpUserName, this.httpPassword, location);
			client.validate();
