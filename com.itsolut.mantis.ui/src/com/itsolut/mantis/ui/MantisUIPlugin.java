...
public class MantisUIPlugin extends AbstractUIPlugin {
	...
	public void start(BundleContext context) throws Exception {
		...
		TasksUiPlugin.getRepositoryManager().addListener(MantisCorePlugin.getDefault().getConnector().getClientManager());
	}

	@Override
	public void stop(BundleContext context) throws Exception {
		TasksUiPlugin.getRepositoryManager().removeListener(MantisCorePlugin.getDefault().getConnector().getClientManager());
