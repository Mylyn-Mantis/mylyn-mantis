...
public class MantisAdditionalInformationPart extends TaskEditorRichTextPart {
	...
	public MantisAdditionalInformationPart() {
		super();
	...
	public void createControl(Composite parent, FormToolkit toolkit) {
		attribute = getTaskData().getRoot().getAttribute(MantisAttributeMapper.Attribute.ADDITIONAL_INFO.getKey());
